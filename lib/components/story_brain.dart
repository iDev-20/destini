import 'package:destini/components/story.dart';
  ...
  final List<Story> _storyData = [
    Story(
        storyTitle:
            ...
            'with no cell phone reception. You decide to hitchhike. A rusty pickup '
            'truck rumbles to a stop next to you. A man with a wide brimmed hat '
            'with soulless eyes opens the passenger door for you and asks: '
            '"Need a ride, boy?".',
    ...
    Story(
        storyTitle:
            ...
            'minute. He asks you to open the glovebox. Inside you find a bloody '
            'knife, two severed fingers, and a cassette tape of Elton John. '
    ...
    Story(
        storyTitle:
            ...
            'go he asks you if you know any good places to dump bodies. '
